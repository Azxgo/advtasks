...
import { statusMap, statusStyles } from "../../utils/formatTodo"
...
export function SubTaskItem({
    ...
    return (
        <div
            className={`group/delete relative flex items-center w-full py-2 px-4  transition-all duration-300
        ...
        >
            ...
            <div className="flex w-full max-w-110 items-center gap-4">
                ...
                {editing ? (
                    <input
                        ...
                        autoFocus
                        className="w-80 border rounded bg-transparent outline-none border-none"
                    />
                ) : (
                    <h2
                        onClick={() => setEditing(true)}
                        className="w-80 truncate select-none cursor-pointer min-h-[1em]"
                    >
                        {subtask.name}
                    </h2>
                )}
